...
//         } else {
//           print(
//               'PRINT LABEL < 0: $calculatedLabelPosition, $labelElement, $arcElements');
//         }
//       }
//     }
//   }
...
//     _previousOutsideLabelX = params[2] as int;
//   }
...
//     var labelLeftOfChart = pi / 2 < centerAbs && centerAbs < pi * 3 / 2;
...
//     var labelY = (labelPoint.y - outsideLabelStyleSpec.fontSize! / 2).round();
...
//       labelY = (_previousOutsideLabelY as int) - 10;
...
//     if (showLeaderLines) {
//       bool isCollided = detectOutsideLabelCollision(labelY, labelLeftOfChart,
//           _previousOutsideLabelY, _previousLabelLeftOfChart);
...
//       labelX =
//           isCollided ? (labelX + tailX - 20).round() : (labelX + tailX).round();
//     }

//     final centerRadius = arcElements.radius - leaderLineStyleSpec.length / 2;
//     double lblX = arcElements.center.x + centerRadius * cos(centerAngle);
//     canvas.drawText(labelElement, lblX.round(), labelY - 8);

//     // Return a structured list of values.
//     return [labelLeftOfChart, labelY, labelX];
//   }
...
//       int labelY,
//       int labelX) {
//     final tailX = (labelLeftOfChart ? -1 : 1) *
//         (isCollided ? 1.0 : leaderLineStyleSpec.length);

//     final leaderLineTailPoint = Point<double>(
//         labelPoint.x + tailX, isCollided ? labelY.toDouble() : labelPoint.y);
